...
namespace Core_Interception
{
    public class IceptKeyboardHandler : DeviceHandlerBase<ManagedWrapper.Stroke>
    {
        ...
        public IceptKeyboardHandler(DeviceDescriptor deviceDescriptor, EventHandler<DeviceDescriptor> deviceEmptyHandler, EventHandler<BindModeUpdate> bindModeHandler, IInputOutputDeviceLibrary<int> deviceLibrary)
