...
namespace SharpDX_DirectInput
{
    ...
    public class SharpDX_DirectInput : IInputProvider, IBindModeProvider
    {
        ...
        public bool SubscribeInput(InputSubscriptionRequest subReq)
        {
            ...
            {
                deviceHandler = new DiDeviceHandler(subReq.DeviceDescriptor, _deviceLibrary.GetDevice(subReq.DeviceDescriptor)).Initialize(DeviceEmptyHandler, BindModeHandler);
        ...
        public void SetDetectionMode(DetectionMode detectionMode, DeviceDescriptor deviceDescriptor, Action<ProviderDescriptor, DeviceDescriptor, BindingDescriptor, int> callback = null)
        {
            ...
            {
                deviceHandler = new DiDeviceHandler(deviceDescriptor, _deviceLibrary.GetDevice(deviceDescriptor)).Initialize(DeviceEmptyHandler, BindModeHandler);
