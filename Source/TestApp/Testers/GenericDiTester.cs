...
namespace TestApp.Testers
{
    public class GenericDiTester
    {
        ...
        public GenericDiTester(string devName, DeviceDescriptor deviceDescriptor)
        {
            ...
            var ps1a1 = new Plugins.IOTester($"{_devName} Axis 1", Library.Providers.DirectInput, _deviceDescriptor, Library.Bindings.Generic.Axis1)
                ...
                .Subscribe();
            var ps1a2 = new Plugins.IOTester($"{_devName} Axis 2", Library.Providers.DirectInput, _deviceDescriptor, Library.Bindings.Generic.Axis2).Subscribe();
            var ps1b1 = new Plugins.IOTester($"{_devName} Button 1", Library.Providers.DirectInput, _deviceDescriptor, Library.Bindings.Generic.Button1)
                //.SubscribeOutput(Library.Providers.ViGEm, Library.Devices.Console.Xb360_1, Library.Bindings.Generic.Button1)
                .Subscribe();
            var ps1b2 = new Plugins.IOTester($"{_devName} Button 2", Library.Providers.DirectInput, _deviceDescriptor, Library.Bindings.Generic.Button2).Subscribe();
